...
from server import service_pb2 as service__pb2
...
def add_ExampleServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'service.Example', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('service.Example', rpc_method_handlers)
